...
namespace ProCarlosV1.Migrations
{
    ...
    [Migration("20240324193620_UpdateEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProCarlosV1.Models.College", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProCarlosV1.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProCarlosV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProCarlosV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProCarlosV1.Models.Student", b =>
                {
                    b.HasOne("ProCarlosV1.Models.College", "College")
                        .WithMany("Students")
