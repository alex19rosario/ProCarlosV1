...
{
    public abstract class ProCarlosV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProCarlosV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProCarlosV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProCarlosV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProCarlosV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProCarlosV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProCarlosV1DbContext, Task<T>> func)
        {
            T result;
